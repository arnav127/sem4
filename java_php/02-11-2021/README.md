...
# PHP Insert, Search and Display Form
Create a php form to register details of students, display all values and search for any student by any of their attributes.

The tables attributes should be as follows: 
...
## Output
![Register Student](s1.png)

![Display All Students](s2.png)

![Search by age](s3.png)

![Search by Name](s4.png)
