# PHP Validation Form
Create a PHP form to input user data and validate it against some filter and constraints. The fields and contraints are:

| S. No. | Field     | Constraint                        |
| -----: | --------- | --------------------------------- |
|      1 | Name      | No numbers and special characters |
|      2 | Email     | Should be a valid email ID        |
|      3 | Mobile No | Should be 10 digits               |
...
## Output
![Errors on Invalid Input](s1.png)

![Successful Submission](s2.png)
